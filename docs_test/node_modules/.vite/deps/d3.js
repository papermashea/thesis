...
function rotationIdentity(lambda, phi) {
  return [abs3(lambda) > pi4 ? lambda + Math.round(-lambda / tau5) * tau5 : lambda, phi];
}
...
function forwardRotationLambda(deltaLambda) {
  return function(lambda, phi) {
    return lambda += deltaLambda, [lambda > pi4 ? lambda - tau5 : lambda < -pi4 ? lambda + tau5 : lambda, phi];
  };
}
