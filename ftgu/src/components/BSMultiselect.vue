...
import listenOnRootMixin  from "bootstrap-vue";
import clickoutMixin from "bootstrap-vue";

export default {
  name: "VueMultiselect",
  mixins: [clickoutMixin, listenOnRootMixin, multiselectMixin, pointerMixin],
  props: {
    /**
